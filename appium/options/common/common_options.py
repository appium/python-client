...
class NewCommandTimeoutOption(SupportsCapabilities):
    ...
    new_command_timeout = OptionsDescriptor[Optional[timedelta], Union[timedelta, int]]
    (NEW_COMMAND_TIMEOUT, transform_command_timeout_get, transfrom_command_timeout_set)
    """
