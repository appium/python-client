...
from appium.options.common.common_options import AutomationNameOption, SystemPortOption

from .gecko_options import AndroidStorageOption, FirefoxOptionsOption, MarionettePortOption, VerbosityOption
