...
class ImagesComparison(webdriver.Remote):
    ...
    def match_images_features(self, base64_image1, base64_image2, **opts):
        ...
        :param base64_image1: base64-encoded content of the first image
        :param base64_image2: base64-encoded content of the second image
    ...
    def find_image_occurrence(self, base64_full_image, base64_partial_image, **opts):
        ...
        :param base64_full_image: base64-encoded content of the full image
        :param base64_partial_image: base64-encoded content of the partial image
        :param opts: Possible options are:
        - visualize: Set it to True in order to return the visualization of the matching operation.
        False by default
        :return:
