...
class IME(CanExecuteCommands):
    ...
    def available_ime_engines(self) -> List[str]:
        ...
        """
        return self.execute(Command.GET_AVAILABLE_IME_ENGINES, {})[
            "value"
    ...
    def is_ime_active(self) -> bool:
        ...
        """
        return self.execute(Command.IS_IME_ACTIVE, {})[
            "value"
        ]  # pylint: disable=unsubscriptable-object
    ...
    def active_ime_engine(self) -> str:
        ...
        """
        return self.execute(Command.GET_ACTIVE_IME_ENGINE, {})[
            "value"
        ]  # pylint: disable=unsubscriptable-object
    ...
    def _add_commands(self) -> None:
        ...
        commands[Command.ACTIVATE_IME_ENGINE] = (
            "POST",
            "/session/$sessionId/ime/activate",
        )
        commands[Command.DEACTIVATE_IME_ENGINE] = (
            "POST",
