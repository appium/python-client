...
class ScreenRecord(webdriver.Remote):
    def start_recording_screen(self: T, **options: Any) -> Union[bytes, str]:
        ...
        Keyword Args:
            ...
            videoFilters (str): [iOS, macOS] The FFMPEG video filters to apply. These filters allow to scale,
            ...
            fps (int): [macOS] The count of frames per second in the resulting video.
                Increasing fps value also increases the size of the resulting video file and the CPU usage.
            captureCursor (bool): [macOS] Whether to capture the mouse cursor while recording the screen.
                Disabled by default.
            captureClick (bool): [macOS] Whether to capture the click gestures while recording the screen.
                Disabled by default.
            ...
            preset (str): [macOS] A preset is a collection of options that will provide a certain encoding
