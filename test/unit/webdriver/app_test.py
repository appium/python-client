...
class TestWebDriverApp:
    ...
    def test_reset(self):
        ...
        assert {"sessionId": "1234567890"}, get_httpretty_request_body(
    ...
    def test_install_app(self):
        ...
        assert {"app": "path/to/app"}, get_httpretty_request_body(
            httpretty.last_request()
        )
        assert isinstance(result, WebDriver)
    ...
    def test_remove_app(self):
        ...
        assert {"app": "com.app.id"}, get_httpretty_request_body(
            httpretty.last_request()
        )
        assert isinstance(result, WebDriver)
